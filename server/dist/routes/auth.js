...
import { authenticate, blacklistToken } from '../middleware/auth.js';
...
authRouter.post('/forgot-password', (req, res) => {
    ...
    const user = db.prepare('SELECT id, username, branch_id FROM users WHERE username = ? AND deleted_at IS NULL').get(username);
    if (user) {
