...
export function resolveTimezone(req) {
    ...
    const sysMode = systemSettings?.timezone_mode === 'MANUAL' ? 'MANUAL' : 'AUTO';
    ...
    const queryOffset = req.query.tzOffset;
...
export function getLocalDateStr(offsetMinutes, baseDate = new Date()) {
