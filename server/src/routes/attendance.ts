...
// 1. Clock In
attendanceRouter.post('/clock-in', authenticate, (req: AuthenticatedRequest, res) => {
...
// 2. Clock Out
attendanceRouter.post('/clock-out', authenticate, (req: AuthenticatedRequest, res) => {
  const userId = req.user!.id;
...
attendanceRouter.get('/', authenticate, (req: AuthenticatedRequest, res) => {
